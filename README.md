...
Откройте файл README.md в редакторе и добавьте:
# Practical Work - GRGU
Выполненные шаги:
### 1. Установка Git
- Скачал Git с официального сайта
- Установил с настройками по умолчанию
- Проверил версию: `git version 2.51.2.windows.1`
### 2. Установка Docker
- Установил Docker Desktop для Windows
- Перезагрузил компьютер после установки
- Проверил версию: `Docker version 28.5.1, build e180ab8`
### 3. Установка Docker Compose
- Docker Compose уже включён в Docker Desktop
- Проверил версию: `Docker Compose version v2.40.2-desktop.1`
### 4. Скриншоты версий
- Приложил скриншоты с версиями установленного ПО
### 5. Запуск контейнера Nginx
- Создал папку `website` в `E:\2\practical-work\`
- Создал файл `index.html` с содержимым "GRGU"
- Запустил контейнер командой:
  ```powershell
  docker run -d --name nginx-container -p 8080:80 -v "${PWD}\website:/usr/share/nginx/html" nginx
